...
np.savetxt("CategoryToClients3.txt", CategoryToClients, fmt='%d')
'''
CategoryToClients_array=np.loadtxt("CategoryToClients3.txt")
...
Categories = [25, 34, 32, 30, 28, 28, 34, 24, 33, 32]
...
np.savetxt("LocalDist_niid_test3.txt", LocalDist_test_array, fmt='%d')
np.savetxt("LocalDist_niid3.txt", LocalDist_train_array, fmt='%d')
'''

LocalDist_array=np.loadtxt("LocalDist_niid3.txt")
LocalDist_test_array=np.loadtxt("LocalDist_niid_test3.txt")
