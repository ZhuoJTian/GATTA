...
class Clients_GATTA:
    def __init__(self, input_shape, num_classes, learning_rate, clients_num, Users, UsersToClient, local_dist, local_dist_test, me):
        self.graph = tf.Graph()
        ...
        self.dataset = Dataset(Users, UsersToClient, local_dist, local_dist_test,
                        split=clients_num)
